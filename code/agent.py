...
def run_agent(pod_name, namespace):
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'vindian, repo 'etx-agentic-ai', "
